...
<body>
  ...
  <div class="slide">
      <div class="container">
          <div class="row">
              <div class="col-md-12">
                  <img src="images/beer1.jpg"  class="img-fluid" alt="">
              </div>
              
          </div>
          <h1>Who am I?</h1>
          <p>I am just a guy who likes to drink.</p>
          <p>Soooooooo...if want to know more about me, let's drink a beer togheter.</p>
          <p>You can find my phone number at the bootom of the page.  </p>
      </div>
  </div>
